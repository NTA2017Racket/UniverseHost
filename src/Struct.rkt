...
Projectile Projectile-uuid Projectile-image Projectile-pos Projectile-velocity Projectile-accleration)
...
(struct Projectile(uuid image pos velocity accleration) #:transparent)