...
(provide GameState GameState-quit GameState-time GameState-players GameState-planets GameState-projectiles GameState-gc
...
(struct GameState(quit time players planets projectiles gc) #:transparent)
