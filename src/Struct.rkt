...
Projectile Projectile-uuid Projectile-pos Projectile-velocity Projectile-accleration Projectile-pool
...
(struct Projectile(uuid pos velocity accleration pool) #:transparent)
