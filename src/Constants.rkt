...
(provide DEFAULTNAME WINDOW.HEIGHT WINDOW.WIDTH BACKGROUNDTEXTURE BACKGROUNDTEXTURE.HEIGHT BACKGROUNDTEXTURE.WIDTH PLANETTEXTURE
 SUNTEXTURE MOONTEXTURE DEFAULTNAME COLORLIST)
...
(define COLORLIST (list "red" "blue" "green" "yellow" "white" "pink"))
