...
(provide DEFAULTNAME WINDOW.HEIGHT WINDOW.WIDTH BACKGROUNDTEXTURE BACKGROUNDTEXTURE.HEIGHT BACKGROUNDTEXTURE.WIDTH PLANETTEXTURE SUNTEXTURE MOONTEXTURE DEFAULTNAME)
